    ...
    <div className="relative">
      <div className="absolute top-[50vh] w-screen flex justify-center">
        <div className="max-w-fit">
          <h1 className="font-extrabold text-transparent text-6xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 text-center">
            Rafael Angonese
          </h1>
          <span className="text-white text-lg flex sm:justify-end justify-center text-center">
      ...
      <div className="absolute top-[120vh] w-screen flex justify-center">
        <div className="max-w-fit">
          <h2 className="font-extrabold text-transparent text-6xl bg-clip-text bg-gradient-to-r from-orange-400 to-green-500 text-center">
            Prepare-se para concretizar suas ideias criativas.
          </h2>

          <span className="text-white text-2xl flex xl:justify-end justify-center text-center">
      ...
      <div className="absolute top-[210vh] w-screen flex justify-center">
        <div className="max-w-fit">
          ...
          <h2 className="mt-8 font-extrabold text-transparent text-6xl bg-clip-text bg-gradient-to-r from-purple-400 to-blue-500 text-center">
            Entre em{" "}
            <span
